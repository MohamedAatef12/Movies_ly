...
import '../../screens/pages/details/person_detail.dart';
...
class ViewPersonDetails extends StatefulWidget {
  ...
  @override
  State<ViewPersonDetails> createState() => _ViewPersonDetailsState();
}
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child:  TabBarView(
                          ...
                          children: [
                            PersonMoviesTab(
                              future: ApiService.getPersonsMovie(widget.id)),
                            PersonTvTab(
                              future: ApiService.getPersonsTv(widget.id),
                            ),
                          ]
                      ),
                    ),
