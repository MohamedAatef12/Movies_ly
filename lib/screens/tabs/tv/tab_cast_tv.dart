...
import '../../../api/api.dart';
import '../../../controller/person/tab_person_tv.dart';
import '../../../models/tv/cast_tv.dart';
import '../../../widgets/widgets.dart';

class TabCastTv extends StatelessWidget {
  const TabCastTv({Key? key,required this.future,})
      : super(key: key);

  final Future<List<CastTv>?> future;
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: FutureBuilder<List<CastTv>?>(
          future: future,
                    ...
                    onTap: (){
                      navigateTo(
                        ...
                        ViewPersonTvDetails(
                          ...
                          id: snapshot.data![index].creditId,
                        ),
                      );
                    },
                    child:Container(
